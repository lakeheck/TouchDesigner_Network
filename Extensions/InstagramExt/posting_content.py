...
params['media_url'] = 'https://freight.cargo.site/t/original/i/e181faf9313ddc48e3b0ed79d09298d7a9111c65f559b4ce99aa2a3b53547615/tectonics_5e3642d4_output.jpg' # url on public server for the post
params['caption'] = 'test'
# params['caption'] += "\n."
# params['caption'] += "\n#creativecoding #generativeart #touchdesigner #prodecuraldesign #watershed" # caption for the post
print(params)
